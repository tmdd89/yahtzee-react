...
const sixes = new TotalOneNumber({ val: 6, description: "5 point per 5" });

// three/four of kind score as sum of all dice
const threeOfKind = new SumDistro({
  count: 3,
  description: "Sum of all dices if 3 are the same",
});
const fourOfKind = new SumDistro({
  count: 4,
  description: "Sum of all dices if 4 are the same",
});
